...
def main():
    ...
    while (pointsPlayer < 12) and (pointsOpponent < 12):
        ...
        for i in range(3):
            ...
            del cardEsc[n]
            shifts.append(winner)

            if (i == 1):
                if ((shifts[0] == "draw") and (shifts[1] == "player")) or ((shifts[0] == "player") and (shifts[1] == "draw")):
                    pointsPlayer += 1
                    break
                elif ((shifts[0] == "draw") and (shifts[1] == "opponent")) or ((shifts[0] == "opponent") and (shifts[1] == "draw")):
                    pointsOpponent += 1
                    break
            elif (i == 2):
                if (shifts[0] == "draw") and (shifts[1] == "draw"):
                    if (shifts[2] == "player"):
                        pointsPlayer += 1
                        break
                    elif (shifts[2] == "opponent"):
                        pointsOpponent += 1
                        break
